      ...
      <div className="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-theme-sm text-gray-500 dark:text-gray-400">
            Example findings from a review snapshot. Not client data.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/review" className="inline-flex items-center gap-2 rounded-lg bg-brand-500 px-4 py-2.5 text-theme-sm font-medium text-white shadow-theme-xs hover:bg-brand-600">
            Request Review
          </Link>
        </div>
      </div>
