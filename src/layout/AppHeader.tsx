...
const reviewHref = "mailto:info@cyberethos.org?subject=Cyber%20Ethos%20Security%20%26%20Ops%20Review";
      ...
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <Link href="/" className="flex items-center gap-2 lg:hidden">
            <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-brand-500 text-sm font-bold text-white">CE</span>
            <span className="text-base font-semibold text-gray-900 dark:text-white">Cyber Ethos</span>
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-2 rounded-full border border-gray-200 bg-gray-50 px-4 py-2 text-xs font-medium text-gray-600 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-300">
